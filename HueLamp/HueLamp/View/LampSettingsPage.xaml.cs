...
namespace HueLamp
{
    ...
    /// </summary>
    public sealed partial class LampSettingsPage : Page
    {
        private NavigateWrapper wrap;
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            NavigateWrapper wrap = (NavigateWrapper)e.Parameter;
            ...
            //wrap.NetHandler.setLamp(wrap.id.ToString(), "200", "200", "200");
        ...
        {
            if(STATUS.IsOn)
            wrap.NetHandler.setLamp(wrap.id.ToString(), BRI.Value.ToString(), HUE.Value.ToString(), SAT.Value.ToString());
        }
        ...
        private void Statustoggle(object sender, RoutedEventArgs e)
        {
            if (STATUS.IsOn)
            {
               
                wrap.NetHandler.setLampState(wrap.id.ToString(), "true");
            }
            else { wrap.NetHandler.setLampState(wrap.id.ToString(), "false"); }
            HUE.IsEnabled = !HUE.IsEnabled;
            SAT.IsEnabled = !SAT.IsEnabled;
            BRI.IsEnabled = !BRI.IsEnabled;
        }
    }
}
